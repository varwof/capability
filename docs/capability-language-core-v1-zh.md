...
> 权威副本在 `data/_vectors/clc-v1/`（`vectors.json` 113 条、`property-cases.json` 1184 条、
...
参考套件检验：`vectors.json` —— **113 条**向量，映射见附录 B —— 与 `property-cases.json`
